...
print(f'{moeda.formatoMoeda(valor_moeda)} + 10% = {moeda.formatoMoeda(moeda.aumentar10(valor_moeda))}')

# diminui o valor em 10%
print(f'{moeda.formatoMoeda(valor_moeda)} - 10% = {moeda.formatoMoeda(moeda.diminui10(valor_moeda))}')
